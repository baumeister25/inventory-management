          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="order in restockingOrders" :key="order.id">
                  ...
                  <details class="items-details">
                    ...
                    <div class="items-dropdown">
                      <div v-for="item in order.items" :key="item.sku" class="item-entry">
                        ...
                        <span class="item-meta">{{ item.quantity }} units @ ${{ item.unit_price }}</span>
                      </div>
                    </div>
                  </details>
                </td>
                ...
                <td class="col-value"><strong>${{ order.total_cost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</strong></td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default {
  ...
  setup() {
    ...
    const loadRestockingOrders = async () => {
      try {
        // Load restocking orders independently; failures don't affect main orders view
